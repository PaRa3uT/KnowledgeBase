...
https://smart-lab.ru/q/ofz/order_by_yield/desc/  

ОФЗ-АД — это бумаги с амортизацией долга  
ОФЗ-ПК – это долговые бумаги с переменным купоном  
ОФЗ-ИН – В данном случае аббревиатура «ИН» подразумевает индексируемый номинал  
...
СамолетР12 (К:13.25%)  
СамолетР11 (К:12.70%)  
РЖД БО 001P-24R (К:11.87%)  
МТС 1Р-20 (К:11.75%)  
Самолет1Р8 (К:11%)  
МТС 1Р-21 (К:9.65%)  
МТС-Банк 001Р-02 (К:9:55%)  
Транснефть БО-001Р-05 (К:9.25%)  
СамолётР10 (К:9.15%)  
РЖД 1P-13R (9.10%)  
РЖД 1P-14R (9.10%)  
Сбер Sb01G (8.80%)  
...
:heavy_minus_sign:ЭБИС Б1Р05 (2025.11.25)(К:14.50%;А)  
:heavy_minus_sign:ЭБИС Б1Р04 (2024.04.09)(К:12.00%)  
...
P/BV = Капитализация / Собственный капитал - Чем меньше, тем лучше (недооценённная компания). соотносит рыночную стоимость компании с размером собственного капитала, зафиксированного в последней финансовой отчетности  
...
## Брокеры
|**Название брокера и тариф** | Сделки на МБ         | Сделки на СПБ         | Исполнение поручений на сделки с производными финансовыми инструментами биржевых рынков
|-----------------------------|----------------------|-----------------------|-------------------------------------------------------------------
|Альфа "Мой Онлайн"           |0.05% от суммы сделки | 0.05% от суммы сделки | 1 рубль за каждый биржевой контракт
|ВТБ "?"                      |s | d|
|Tinkoff "?"                  |s | d|
|Сбербанк "?"                 |s | d|
...
* PoS - proof-of-stack, доказательство доли владения
