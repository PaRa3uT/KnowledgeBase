import{_ as e,o as a,c as t,e as n}from"./app.11ae776d.js";const r={},d=n(`<h1 id="alpine" tabindex="-1"><a class="header-anchor" href="#alpine" aria-hidden="true">#</a> Alpine</h1><p>cat /etc/os-release init system: OpenRC</p><h2 id="install" tabindex="-1"><a class="header-anchor" href="#install" aria-hidden="true">#</a> Install:</h2><pre><code>setup-alpine
...
</code></pre>`,26),s=[d];function o(i,p){return a(),t("div",null,s)}var u=e(r,[["render",o],["__file","alpine.html.vue"]]);export{u as default};
