import{_ as s,r as n,o as t,c as r,a as e,d as o,b as i,e as c}from"./app.11ae776d.js";const l={},d={id:"linux-from-scratch",tabindex:"-1"},p=e("a",{class:"header-anchor",href:"#linux-from-scratch","aria-hidden":"true"},"#",-1),h=i(),u={href:"https://www.linuxfromscratch.org/",target:"_blank",rel:"noopener noreferrer"},m=i("Linux From Scratch"),g=c(`<pre><code>Live CD for building LFS: slax, Calculate Linux Xfce Live, Slackware, Debian

/lfs_host_system_requirements.sh
</code></pre><h2 id="creating-a-file-system-on-the-partition" tabindex="-1"><a class="header-anchor" href="#creating-a-file-system-on-the-partition" aria-hidden="true">#</a> Creating a File System on the Partition</h2><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>mkfs -v -t ext4 /dev/&lt;xxx&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="setting-the-lfs-variable" tabindex="-1"><a class="header-anchor" href="#setting-the-lfs-variable" aria-hidden="true">#</a> Setting The $LFS Variable</h2><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>export LFS=/mnt/lfs
echo $LFS
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="mounting-the-new-partition" tabindex="-1"><a class="header-anchor" href="#mounting-the-new-partition" aria-hidden="true">#</a> Mounting the New Partition</h2><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>mkdir -pv $LFS
mount -v -t ext4 /dev/&lt;xxx&gt; $LFS

mkdir -v $LFS/home
mount -v -t ext4 /dev/&lt;yyy&gt; $LFS/home
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="packages-and-patches" tabindex="-1"><a class="header-anchor" href="#packages-and-patches" aria-hidden="true">#</a> Packages and Patches</h2><p>https://www.linuxfromscratch.org/lfs/view/11.0/chapter03/packages.html</p><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>mkdir -v $LFS/sources
...
pushd $LFS/sources
  md5sum -c md5sums
popd
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="creating-a-limited-directory-layout-in-lfs-filesystem" tabindex="-1"><a class="header-anchor" href="#creating-a-limited-directory-layout-in-lfs-filesystem" aria-hidden="true">#</a> Creating a limited directory layout in LFS filesystem</h2><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>mkdir -pv $LFS/{etc,var} $LFS/usr/{bin,lib,sbin}
...
mkdir -pv $LFS/tools
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="adding-the-lfs-user" tabindex="-1"><a class="header-anchor" href="#adding-the-lfs-user" aria-hidden="true">#</a> Adding the LFS User</h2><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>groupadd lfs
...
su - lfs
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="setting-up-the-environment" tabindex="-1"><a class="header-anchor" href="#setting-up-the-environment" aria-hidden="true">#</a> Setting Up the Environment</h2><div class="language-text ext-text line-numbers-mode"><pre class="language-text"><code>cat &gt; ~/.bash_profile &lt;&lt; &quot;EOF&quot;
...
</code></pre>`,17);function f(v,b){const a=n("ExternalLinkIcon");return t(),r("div",null,[e("h1",d,[p,h,e("a",u,[m,o(a)])]),g])}var y=s(l,[["render",f],["__file","lfs.html.vue"]]);export{y as default};
