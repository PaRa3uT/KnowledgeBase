import{_ as e,o as a,c as i,e as n}from"./app-9ee1dfa4.js";const d={},s=n(`<h1 id="" tabindex="-1"><a class="header-anchor" href="#" aria-hidden="true">#</a></h1><h2 id="-1" tabindex="-1"><a class="header-anchor" href="#-1" aria-hidden="true">#</a></h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>w (показывает текущее время, uptime, load average, залогиненного пользователя, его терминал, время логина, ip адрес и что у него запущено в данный момент)
