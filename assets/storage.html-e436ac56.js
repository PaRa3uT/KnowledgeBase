import{_ as e,o as a,c as d,e as i}from"./app-9ee1dfa4.js";const n={},s=i(`<h1 id="storage" tabindex="-1"><a class="header-anchor" href="#storage" aria-hidden="true">#</a> Storage</h1><h2 id="ssd-windows" tabindex="-1"><a class="header-anchor" href="#ssd-windows" aria-hidden="true">#</a> SSD Windows</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>проверить, включена ли поддержка TRIM
cmd -&gt; fsutil behavior query disabledeletenotify
NTFS DisableDeleteNotify = 0 (TRIM включен)
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>включить TRIM для SSD в Windows
cmd -&gt; fsutil behavior set disabledeletenotify NTFS 0
    -&gt; fsutil behavior set disabledeletenotify ReFS 0 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="partioning" tabindex="-1"><a class="header-anchor" href="#partioning" aria-hidden="true">#</a> Partioning</h2><h3 id="server" tabindex="-1"><a class="header-anchor" href="#server" aria-hidden="true">#</a> Server</h3><p>/boot xfs ~1GB / xfs(LVM)</p><h2 id="geom-bsd" tabindex="-1"><a class="header-anchor" href="#geom-bsd" aria-hidden="true">#</a> GEOM (BSD)</h2><h3 id="raid-0" tabindex="-1"><a class="header-anchor" href="#raid-0" aria-hidden="true">#</a> RAID 0</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>1. # kldload geom_stripe (Загрузите модуль geom_stripe.ko)
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="xfs" tabindex="-1"><a class="header-anchor" href="#xfs" aria-hidden="true">#</a> XFS</h2><h2 id="ext-4" tabindex="-1"><a class="header-anchor" href="#ext-4" aria-hidden="true">#</a> Ext 4</h2><h2 id="ext-3" tabindex="-1"><a class="header-anchor" href="#ext-3" aria-hidden="true">#</a> Ext 3</h2><h2 id="ext-2" tabindex="-1"><a class="header-anchor" href="#ext-2" aria-hidden="true">#</a> Ext 2</h2><h2 id="reiserfs" tabindex="-1"><a class="header-anchor" href="#reiserfs" aria-hidden="true">#</a> ReiserFS</h2><h2 id="fat-32" tabindex="-1"><a class="header-anchor" href="#fat-32" aria-hidden="true">#</a> FAT 32</h2><h2 id="fat-16" tabindex="-1"><a class="header-anchor" href="#fat-16" aria-hidden="true">#</a> FAT 16</h2><h2 id="fat-12" tabindex="-1"><a class="header-anchor" href="#fat-12" aria-hidden="true">#</a> FAT 12</h2><h2 id="exfat" tabindex="-1"><a class="header-anchor" href="#exfat" aria-hidden="true">#</a> exFAT</h2><h2 id="mbr-to-gpt" tabindex="-1"><a class="header-anchor" href="#mbr-to-gpt" aria-hidden="true">#</a> MBR to GPT</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Offline
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,39),r=[s];function t(l,o){return a(),d("div",null,r)}const c=e(n,[["render",t],["__file","storage.html.vue"]]);export{c as default};
