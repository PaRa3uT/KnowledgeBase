import{_ as e,o as i,c as n,e as s}from"./app-024c187f.js";const d={},l=s(`<h1 id="пакетныи-менеджер-yum" tabindex="-1"><a class="header-anchor" href="#пакетныи-менеджер-yum" aria-hidden="true">#</a> Пакетный менеджер YUM</h1><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>yum help (отображение команд и опций)
