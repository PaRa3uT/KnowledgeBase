import{_ as a,c as n,b as t,o as r}from"./app-BsHIgujo.js";const o={};function i(d,e){return r(),n("div",null,e[0]||(e[0]=[t(`<h1 id="radio" tabindex="-1"><a class="header-anchor" href="#radio"><span>Radio</span></a></h1><p>Радиостанции (Челябинск) 91 МГц - Вести FM Южный Урал 92.595.5 - 93.6 - 94.6 - 95.3 - 96.4 - 97.8 - 98.4 99.1 - Авто Радио 99.4 100 - 100.4 - 100.8 - Бизнес ФМ 101.2 - Юмор ФМ 101.6 - Europa Plus 102.0 - 102.4 - 102.9 103.5 - Наше радио 104.1 104.5 104.9 105.4 105.9 106.3 106.8 -</p><p>Рации (Челябинск) 431.537.500 432.200.000 433.202 433.410.000 433.777.000 443.200.000 (?) 449.150.00</p><p>Челябинск (Баландино) 4712 кГц - Челябинск-Радио 124.700 МГц - Челябинск-Подход <em>125.200 МГц - Челябинск-Старт (125.200.200 bandwidth 1065) 125.400 МГц - Челябинск-Контроль (сектор 245</em>-008*) <em>125.500 МГц - Челябинск-Контроль (сектор 105</em>-245*) (125.500.400 Какая то передача была, при подходе самолёта снизу) 128.300 МГц - Челябинск-Метео 131.600 МГц - Челябинск-Транзит 133.200 МГц - Челябинск-Контроль (сектор 008*-105*) Шагол 134.075</p><h2 id="sdr" tabindex="-1"><a class="header-anchor" href="#sdr"><span>SDR</span></a></h2><pre><code>Zadig - https://zadig.akeo.ie/
...
</code></pre><p>Другие применения и границы возможного RTL2832 можно использовать для отладки радиопередатчиков, подслушивания за радионянями и аналоговыми радиотелефонами, для разбора протоколов связи в игрушках на радиоуправлении, радиозвонках, пультов от машин, погодных станций, систем удаленного сбора информации с датчиков, электросчетчиков. С конвертором можно считывать код с простейших 125 кГц RFID меток. Сигналы можно записывать днями, анализировать и затем повторить в эфир на передающем оборудовании. При необходимости тюнер можно подключить к Android-устройству, Raspberry Pi или другому компактному компьютеру для организации автономного сбора данных из радиоэфира. Можно принимать фотографии с погодных спутников и слушать передачи с МКС — но тут уже потребуются специальные антенны, усилители. Фотографии декодируются программой WXtoImg (http://www.wxtoimg.com/). Есть возможность захватывать зашифрованные данные, передаваемые GSM-телефонами (проект airprobe), в случае если в сети отключен frequency-hopping. Возможности SDR на основе RTL2832 все-таки не безграничны: до Wi-Fi и Bluetooth он не достает по частоте, и, даже если сделать конвертер, из-за того, что полоса захватываемых частот не может быть шире ~2,8 МГц, невозможно будет принимать даже один канал Wi-Fi. Bluetooth 1600 раз в секунду меняет рабочую частоту в диапазоне 2400–2483МГц, и за ним будет не угнаться. По этой же причине невозможен полноценный прием аналогового телевидения (там нужна принимаемая полоса 8 МГц, с 2,8 МГц можно получить только черно-белую картинку без звука). Для таких применений нужны более серьезные SDR-приемники: HackRF, bladeRF, USRP1 и другие.</p><h2 id="dvb-t" tabindex="-1"><a class="header-anchor" href="#dvb-t"><span>DVB-T</span></a></h2><pre><code>DVB-T Driver - https://mega.nz/file/zgplmLyR#NvpfJVO8KakkDBpXmVPfWCTkml4VKMk7T6MRptTF6dg
?ProgDVB - https://www.progdvb.com/download_progdvb.html
</code></pre>`,9)]))}const p=a(o,[["render",i],["__file","radio.html.vue"]]),s=JSON.parse('{"path":"/unsorted/radio.html","title":"Radio","lang":"en-US","frontmatter":{},"headers":[{"level":2,"title":"SDR","slug":"sdr","link":"#sdr","children":[]},{"level":2,"title":"DVB-T","slug":"dvb-t","link":"#dvb-t","children":[]}],"git":{"updatedTime":1681201131000,"contributors":[{"name":"PaRa3uT","username":"PaRa3uT","email":"PaRa3uT.74@gmail.com","commits":1,"url":"https://github.com/PaRa3uT"}]},"filePathRelative":"unsorted/radio.md"}');export{p as comp,s as data};
