import{_ as e,o as n,c as i,e as d}from"./app-9ee1dfa4.js";const s={},a=d(`<h1 id="docker" tabindex="-1"><a class="header-anchor" href="#docker" aria-hidden="true">#</a> Docker</h1><p>docker inspect &lt;image_name&gt;<br> docker run &lt;image_name&gt; (запустить контейнер)<br> docker run &lt;image_id&gt;<br> docker stop &lt;image_name&gt;</p><h2 id="list-docker-cli-commands" tabindex="-1"><a class="header-anchor" href="#list-docker-cli-commands" aria-hidden="true">#</a> List Docker CLI commands</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>docker  
docker info
